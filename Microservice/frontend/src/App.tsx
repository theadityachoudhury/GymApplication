...
function App() {
	...
	const { initialAuthCheckComplete, isLoading, userDetail } =
			...
			<Routes>
				...
				<Route element={<PrivateComponent />}>
					...
					<Route path="/profile" element={<MyAccount />}>
						...
						{!isLoading && userDetail && userDetail.id && <Route path="feedbacks" element={<CoachFeedbacks coachId={userDetail.id} />} />}
						<Route
