...
const FeedbackSection: React.FC<FeedbackSectionProps> = ({ coachId }) => {
		...
		<div className="w-full">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				...
				{feedback.items.length === 0 && (
					<div className="col-span-1 md:col-span-3 flex flex-col items-center justify-center h-full p-6 bg-primary-white rounded-xl shadow-md">
